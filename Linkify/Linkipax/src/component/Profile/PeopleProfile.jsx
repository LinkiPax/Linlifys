...
import { FiAward, FiBriefcase, FiMapPin, FiMail, FiUsers, FiStar } from "react-icons/fi";
import { RiSuitcaseLine, RiUserStarLine, RiShareForwardLine } from "react-icons/ri";
import { IoMdNotificationsOutline, IoMdRibbon } from "react-icons/io";
import { BsThreeDotsVertical, BsBookmark, BsFillLightningFill } from "react-icons/bs";
        ...
        return (
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              className="rounded-pill px-4 d-flex align-items-center people-profile-connect-btn"
            >
          ...
          <div className="d-flex gap-2">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="rounded-pill px-4 d-flex align-items-center people-profile-message-btn"
              >
  ...
  return (
    ...
    >
      <Container className="mt-4">
        {feedback.show && (
          ...
          >
            <Alert
              ...
              className="shadow-lg people-profile-alert"
        ...
        {/* Profile Header */}
        <Card className="people-profile-header-card shadow-sm mb-4 border-0 overflow-hidden">
          {backgroundImage?.secure_url && (
            <div
              className="people-profile-banner"
              style={{
          ...
          <Card.Body className="position-relative pt-5 pb-4">
            <div className="d-flex flex-column flex-md-row align-items-start">
              ...
              <div className="people-profile-picture-container mb-3 mb-md-0 mx-auto mx-md-0">
                <motion.div
                ...
                >
                  <img
                    src={profilePicture}
                    alt="Profile"
                    className="rounded-circle border border-4 border-white shadow people-profile-image"
                  />
                  <div className="people-profile-online-indicator"></div>
                </motion.div>
              </div>
              ...
              <div className="ms-md-5 ps-md-5 mt-4 mt-md-0 flex-grow-1">
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    <div className="d-flex align-items-center flex-wrap gap-2 mb-2">
                      <h2 className="mb-0 fw-bold people-profile-name">{name}</h2>
                      <Badge bg="success" className="people-profile-verified-badge">
                        <FiStar className="me-1" /> Verified
                      </Badge>
                    </div>
                    <h5 className="text-primary mb-2 people-profile-jobtitle">{jobTitle}</h5>
                    <div className="d-flex align-items-center text-muted mb-3 flex-wrap people-profile-meta">
                  ...
                  <div className="d-flex gap-2 align-items-center people-profile-actions">
                    {getConnectionButton()}
                    <div className="position-relative">
                      <Button 
                        variant="outline-secondary" 
                        className="rounded-circle p-2 people-profile-more-btn" 
                      ...
                      <AnimatePresence>
                        {showMoreOptions && (
                          <motion.div
                            ...
                            exit={{ opacity: 0, y: 10 }}
                            className="people-profile-more-options shadow"
                          >
                            ...
                            <Button variant="link" className="d-flex align-items-center w-100 text-start">
                              <RiShareForwardLine className="me-2" /> Share Profile
                            </Button>
                          </motion.div>
                        )}
                      </AnimatePresence>
                ...
                {/* Stats Section */}
                <div className="people-profile-stats row g-3 mt-3">
                  <div className="col-auto">
                    <div className="people-profile-stat-item">
                      <BsFillLightningFill className="people-profile-stat-icon text-warning" />
                      <div>
                        <span className="people-profile-stat-number">{stats.projectsCompleted}</span>
                        <span className="people-profile-stat-label">Projects</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-auto">
                    <div className="people-profile-stat-item">
                      <IoMdRibbon className="people-profile-stat-icon text-info" />
                      <div>
                        <span className="people-profile-stat-number">{stats.recommendations}</span>
                        <span className="people-profile-stat-label">Recommends</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-auto">
                    <div className="people-profile-stat-item">
                      <FaCalendarAlt className="people-profile-stat-icon text-success" />
                      <div>
                        <span className="people-profile-stat-number">{stats.yearsExperience}+</span>
                        <span className="people-profile-stat-label">Years</span>
                      </div>
                    </div>
                  </div>
                </div>

                <div className="d-flex flex-wrap gap-2 mt-3 people-profile-social">
                  {Object.entries(socialLinks).map(([platform, url]) => (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="btn btn-outline-dark btn-sm rounded-circle people-profile-social-icon"
        ...
        <Row className="g-4">
          <Col lg={4}>
            {/* About Card */}
            <Card className="people-profile-card shadow-sm h-100">
              <Card.Body>
                <h5 className="mb-3 fw-bold people-profile-card-title">
                  <TbTargetArrow className="me-2" /> About
                </h5>
                <p className="text-muted people-profile-bio">{bio || "No bio provided"}</p>

                <div className="mt-4">
                  <h6 className="text-muted mb-3 fw-bold people-profile-section-title">Details</h6>
                  <ul className="list-unstyled people-profile-details">
                    <li className="mb-2 d-flex align-items-start">
                      <RiSuitcaseLine className="me-2 mt-1 flex-shrink-0 people-profile-detail-icon" />
                      <div>
                    ...
                    {education.length > 0 && (
                      <li className="mb-2 d-flex align-items-start">
                        <FaGraduationCap className="me-2 mt-1 flex-shrink-0 people-profile-detail-icon" />
                        <div>
                    ...
                    <li className="mb-2 d-flex align-items-start">
                      <FiMail className="me-2 mt-1 flex-shrink-0 people-profile-detail-icon" />
                      <div>
            ...
            {/* Skills Card */}
            {skills.length > 0 && (
              <Card className="people-profile-card shadow-sm mt-4">
                <Card.Body>
                  <h5 className="mb-3 fw-bold people-profile-card-title">
                    <BsFillLightningFill className="me-2" /> Skills
                  </h5>
                  {skills.map((skill) => (
                    <div key={skill.name} className="mb-3 people-profile-skill">
                      <div className="d-flex justify-content-between mb-1">
                        <span className="people-profile-skill-name">{skill.name}</span>
                        <span className="people-profile-skill-level">{skill.level}%</span>
                      </div>
                      <ProgressBar
                        now={skill.level}
                        variant="primary"
                        className="rounded-pill people-profile-skill-progress"
                      />
                    </div>
                  ))}
                </Card.Body>
            ...
            {(interests.length > 0 || hobbies.length > 0) && (
              <Card className="people-profile-card shadow-sm mt-4">
                <Card.Body>
                  <h5 className="mb-3 fw-bold people-profile-card-title">
                    <FaHeart className="me-2" /> Interests & Hobbies
                  </h5>

                  {interests.length > 0 && (
                    <>
                      <h6 className="text-muted mb-2 people-profile-section-title">Interests</h6>
                      <div className="mb-3">
                        {interests.map((interest, idx) => (
                          ...
                          >
                            <Badge pill bg="info" className="people-profile-interest-badge">
                              {interest}
                            </Badge>
                          </motion.div>
                        ))}
                  ...
                  {hobbies.length > 0 && (
                    <>
                      <h6 className="text-muted mb-2 people-profile-section-title">Hobbies</h6>
                      <div>
                        {hobbies.map((hobby, idx) => (
                          <motion.div
                            ...
                            className="d-inline-block me-2 mb-2"
                          >
                            <Badge pill bg="secondary" className="people-profile-hobby-badge">
                              {hobby}
                            </Badge>
                          </motion.div>
                        ))}
          ...
          <Col lg={8}>
            <Card className="people-profile-card shadow-sm">
              <Card.Body>
                <Tabs
                  activeKey={activeTab}
                  onSelect={(k) => setActiveTab(k)}
                  className="mb-4 people-profile-tabs"
                  fill
                >
                  <Tab eventKey="about" title={
                    ...
                    <div className="mt-3">
                      <h5 className="mb-3 fw-bold people-profile-section-title">Professional Summary</h5>
                      <p className="text-muted people-profile-bio">
                        {bio || "No professional summary provided"}
                      </p>

                      {achievements.length > 0 && (
                        <>
                          <h5 className="mt-4 mb-3 fw-bold people-profile-section-title">Achievements</h5>
                          <ListGroup variant="flush" className="people-profile-achievement-list">
                            {achievements.map((ach, idx) => (
                              <ListGroup.Item
                                key={idx}
                                className="d-flex align-items-center people-profile-achievement-item"
                              >
                                <FiAward
                                  className="text-warning me-3 flex-shrink-0 people-profile-achievement-icon"
                                />
                                <span>{ach}</span>
                              </ListGroup.Item>
                            ))}
                  ...
                  <Tab eventKey="experience" title={
                    ...
                    <div className="mt-3">
                      <h5 className="mb-3 fw-bold people-profile-section-title">Work Experience</h5>
                      <div className="people-profile-timeline">
                        {experience.length > 0 ? (
                          experience.map((exp, idx) => (
                            <div className="people-profile-timeline-item" key={idx}>
                              <div className="people-profile-timeline-point"></div>
                              <div className="people-profile-timeline-content">
                          ...
                          <div className="people-profile-timeline-item">
                            <div className="people-profile-timeline-point"></div>
                            <div className="people-profile-timeline-content">
                  ...
                  <Tab eventKey="projects" title={
                    ...
                    <div className="mt-3">
                      <h5 className="mb-3 fw-bold people-profile-section-title">Recent Projects</h5>
                      {projects.length > 0 ? (
                        <Row className="g-4">
                          {projects.map((project, idx) => (
                            <Col md={6} key={idx}>
                              <motion.div whileHover={{ y: -5 }}>
                                <Card className="h-100 people-profile-project-card">
                                  <div className="people-profile-project-image-container">
                                    <Card.Img
                                      variant="top"
                                      src={
                                        project.image ||
                                      ...
                                      className="people-profile-project-image"
                                    />
                                  </div>
                                  <Card.Body>
            ...
            <Card className="people-profile-card shadow-sm mt-4">
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5 className="mb-0 fw-bold people-profile-section-title">Recent Activity</h5>
                  <Button variant="link" className="text-primary p-0 people-profile-see-all">See all</Button>
                </div>
                <div className="people-profile-activity-item">
                  <div className="people-profile-activity-avatar">
                    <img
                      src={profilePicture}
                      alt="User"
                  ...
                  <div className="people-profile-activity-content">
                    ...
                    <div className="people-profile-activity-actions mt-2">
        ...
        <Modal
          ...
          centered
          className="people-profile-message-modal"
        >
          ...
          <Modal.Body className="pt-0">
            <textarea
              className="form-control people-profile-message-textarea"
              rows="5"
          ...
          <Modal.Footer className="border-0">
            ...
            <Button
              ...
              className="rounded-pill px-4 people-profile-send-message-btn"
            >
              Send Message
            </Button>
          </Modal.Footer>
